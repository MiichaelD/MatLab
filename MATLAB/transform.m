...
%esto del 23 de octubre
A=[1];
N = 150;%orden
%B=fir1(150,wp,'high');% tipo de frecuencia normalizada
B=fir1(N,Wn,'high',kaiser(N+1,4));% tipo de frecuencia normalizada
z=filter(B,A,x);%convolucion
